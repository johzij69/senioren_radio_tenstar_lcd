...
// const char *path = "//radio2-sterrennl-mp3";
// int httpPort = 443;
...
const char *urls[] = {
  "https://icecast.omroep.nl/radio1-bb-mp3:443",
  "https://icecast.omroep.nl/radio2-bb-mp3:443",
  "https://icecast.omroep.nl/3fm-bb-mp3:443"
};
...
void loop()
{
  ...
  if(next_button.isPressed()) 
  {
    ...
    Serial.println(urls[stream_counter]);
     player.stop();
     player.resetStream();
  ...
  if(next_button.isReleased())
    ...
    player.playUrl(urls[stream_counter]);  
